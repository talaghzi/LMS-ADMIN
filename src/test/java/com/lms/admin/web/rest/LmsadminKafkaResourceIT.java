...
public class LmsadminKafkaResourceIT {
    ...
    @Autowired
    private LmsadminKafkaProducer producer;

    @Autowired
    private LmsadminKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        LmsadminKafkaResource kafkaResource = new LmsadminKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/lmsadmin-kafka/publish?message=test"))
